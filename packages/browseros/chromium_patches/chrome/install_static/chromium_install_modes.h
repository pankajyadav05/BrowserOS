...
+            L"{CF887152-7CB8-4393-84CC-1BACF0EDE1D1}",  // Mitria app GUID.
+        .base_app_name = L"Mitria",              // A distinct base_app_name.
+        .base_app_id = L"Mitria",                // A distinct base_app_id.
+        .browser_prog_id_prefix = L"MitriaHTML",  // Browser ProgID prefix.
         .browser_prog_id_description =
-            L"Chromium HTML Document",         // Browser ProgID description.
-        .pdf_prog_id_prefix = L"ChromiumPDF",  // PDF ProgID prefix.
+            L"Mitria HTML Document",         // Browser ProgID description.
+        .pdf_prog_id_prefix = L"MitriaPDF",  // PDF ProgID prefix.
         .pdf_prog_id_description =
-            L"Chromium PDF Document",  // PDF ProgID description.
+            L"Mitria PDF Document",  // PDF ProgID description.
         .active_setup_guid =
